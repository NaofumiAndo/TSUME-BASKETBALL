...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-zinc-950 p-3 md:p-6 selection:bg-orange-500 overflow-x-hidden pb-10">
      <header className="w-full max-w-lg mb-4 relative">
      ...
      <div className="w-full max-w-lg flex flex-col gap-3">
        {gameState.phase === 'menu' ? (
          ...
          <>
            ...
            <div className={`w-full max-w-[470px] mx-auto bg-zinc-900 border border-zinc-700 rounded-lg px-4 py-2 relative z-30 ${is3DMode ? 'mb-0' : 'mb-2'}`}>
            ...
            <div className="space-y-4">
              <section>
                ...
                <div className="space-y-2 text-[9px] font-bold text-zinc-400 leading-relaxed uppercase">
                  ...
                  <p className="mt-2"><span className="text-white">How to Screen:</span> Place an <span className="text-white">off-ball support player</span> directly next to a defender (horizontally or vertically). Screened defenders <span className="text-orange-400">cannot move into blocks adjacent</span> to the screening player, limiting their defensive options significantly.</p>
